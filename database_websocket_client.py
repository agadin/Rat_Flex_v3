...
class DatabaseWebSocketClient:
    def __init__(self, server_url="ws://localhost:8765"):
        ...
        self.ws.connect(server_url)  # Connect to the WebSocket server
    ...
    def update_db(self, current_direction=None, current_angle=None, angle_to_step_ratio=None, motor_state=None):
        ...
        response = self.send_db_command("update_motor_state", data)
...
if __name__ == "__main__":
    ...
    response = db_client.update_db(current_direction="forward", current_angle=90, motor_state="moving")
