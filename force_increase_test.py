...
plt.plot(x_values, [(180-val)+31 for val in final_curve_3], marker='^', linestyle='-.', label='Cycle 1', color='orange')
plt.plot(x_values, [(180-val)+31 for val in final_curve_7], marker='s', linestyle='--', label='Cycle 2', color='green')
plt.plot(x_values, [(180-val)+31 for val in final_curve_11], marker='o', linestyle='-', label='Cycle 3', color='blue')


# Format the second plot
plt.xlabel('Force Threshold (N)')
plt.ylabel('Arm Angle (degrees)')
plt.title('End flexion angle at different Force Thresholds on Uninjured Arm')
plt.grid()
plt.legend()
plt.tight_layout()
...
plt.figure(figsize=(8, 5))
plt.plot(x_values, [180-(val-31) for val in final_curve_1], marker='d', linestyle=':', label='Cycle 1', color='red')
plt.plot(x_values, [180-(val-31) for val in initial_curve_3], marker='^', linestyle='-.', label='Cycle 1', color='orange')
plt.plot(x_values, [180-(val-31) for val in initial_curve_7], marker='s', linestyle='--', label='Cycle 2', color='green')
plt.plot(x_values, [180-(val-31) for val in initial_curve_11], marker='o', linestyle='-', label='Cycle 3', color='blue')


# Format the second plot
plt.xlabel('Force Threshold (N)')
plt.ylabel('Arm Angle (degrees)')
plt.title('End extension arm angle at different Force Thresholds on Uninjured Arm')
plt.grid()
plt.legend()
plt.tight_layout()
plt.ylim(166, 180)
plt.yticks(ticks=range(166, 181, 2))
